...
wd.registerObserver(priority: 3, observer: display3, events: [WeatherEvent.temperature])
wd.registerObserver(priority: 2, observer: statsDisplay, events: [WeatherEvent.speed])
...
wd.setMeasurements(temperature: 60, humidity: 20, pressure: 30, windSpeed: 15, windDirection: 90)
wd.setMeasurements(temperature: 60, humidity: 20, pressure: 30, windSpeed: 15, windDirection: 180)
